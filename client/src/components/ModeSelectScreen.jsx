      ...
      <div className="mode-select__inner">
        ...
        <div className="mode-select__cards">
          ...
          <button className="mode-card mode-card--battle" onClick={onSelectBattle}>
            ...
            <div className="mode-card__desc">
              Create a private room or join a friend's. Everyone gets the same 10 words — whoever's drawing gets the highest AI confidence wins the point!
            </div>
            <div className="mode-card__pills">
              <span className="mode-pill">10 Shared Words</span>
              <span className="mode-pill">2–8 Players</span>
